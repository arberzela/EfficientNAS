...
python cifar10_master.py --array_id $SLURM_ARRAY_TASK_ID --total_num_workers 20 --num_iterations 64 --run_id $SLURM_ARRAY_JOB_ID --working_directory ./data/run_$SLURM_ARRAY_JOB_ID
